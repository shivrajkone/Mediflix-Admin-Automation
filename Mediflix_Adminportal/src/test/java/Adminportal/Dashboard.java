...
//	 @Test (enabled = false)
	 public void Verify_The_Dashboard_collection() throws InterruptedException 
	 {
		...
		// collection click
		 ...
		 apply.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[2]/div[3]/div/div[2]/button[2]"))).click();
	...
	//	 Thread.sleep(7000);
		 ...
		 coll_count = coll_count.substring(8);
				...
				//filter click
				 ...
				 apply2.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[2]/div[3]/div/div[2]/button[2]"))).click();
